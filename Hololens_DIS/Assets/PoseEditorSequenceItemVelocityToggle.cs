...
public class PoseEditorSequenceItemVelocityToggle : PoseEditorSequenceItemToggleBase
{
    public override void Select()
    {
        Debug.Log("Select Velocity");
        if (true)
        {
            /*
             * TODO:
            ...
            if (rate > 1)
            {
                ...
                poseEditorSequenceItem.poseSequence.velocities[originalIndex] = !allOn;
            }
            else
            {
                ...
                for (int i = originalMin; i <= originalMax; i++)
                    poseEditorSequenceItem.poseSequence.velocities[i] = toggle.isOn;
            }
