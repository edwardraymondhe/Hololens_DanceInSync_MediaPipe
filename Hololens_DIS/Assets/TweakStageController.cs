...
public class TweakStageController : BaseStageController
{
    public GameObject staminaSettingPrefab;
    public GameObject musicSettingPrefab;

    public Dictionary<PoseSequence, float> musicModeData = new Dictionary<PoseSequence, float>();
    ...
    {
        SetModeData(musicModeData, poseSequence, value);
    }
